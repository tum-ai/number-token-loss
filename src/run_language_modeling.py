...
def main():
    ...
    train_data_path = 'data/grade-school-math/grade_school_math/data/preprocessed/reduced_debug.jsonl'
    eval_data_path = 'data/grade-school-math/grade_school_math/data/preprocessed/reduced_debug.jsonl'
    test_data_path = 'data/grade-school-math/grade_school_math/data/preprocessed/reduced_debug.jsonl'
